...
public class Perpustakaan {
    ...
    public static void main(String[] args) {
        ...
        //pembuatan object yg berisi nama petugas
        ...
        while (stay) {
            ...
            System.out.println("---- Kediri Library ---");
            System.out.println("");
            System.out.println("Perkenalkan Saya "+ptgs.getNama(0) + " admin disini");
            System.out.println("");
            ...
            if (menu == 1) {
                ...
                if (selectedSiswa.isStatus()) {
                    ...
                    System.out.println("Peminjam: " + selectedSiswa.getNama(0));

                    //proses pengurangan stok
                    listBuku.listBuku[foundIndex].kurangiStok(0);
                ...
                siswa selectedSiswa = listSiswa.listSiswa[foundIndex];
                    ...
                    System.out.print("Pilih ID buku yang dipinjam untuk dikembalikan: ");
                    selectedIDBuku = input.nextInt();
                    foundIndex = listBuku.cariBuku(selectedIDBuku);
                    ...
                    listBuku.listBuku[foundIndex].tambahStok(0);
